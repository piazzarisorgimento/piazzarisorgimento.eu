...
return [
    ...
    'The picture #:key size may not be lower than :min.' => 'El tamaño de la imagen #:key no puede ser inferior a :min.',
    'The picture #:key size may not be greater than :max.' => 'El tamaño de la imagen #:key no puede ser mayor que :max.',
