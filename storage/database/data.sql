...
INSERT INTO `<<prefix>>settings` (`id`, `key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`) VALUES(7, 'upload', 'Upload', NULL, 'Upload Settings', NULL, 0, 14, 15, 1, 1, NULL, NULL);
INSERT INTO `<<prefix>>settings` (`id`, `key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`) VALUES(8, 'geo_location', 'Geo Location', NULL, 'Geo Location Configuration', NULL, 0, 16, 17, 1, 1, NULL, NULL);
INSERT INTO `<<prefix>>settings` (`id`, `key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`) VALUES(9, 'security', 'Security', NULL, 'Security Options', NULL, 0, 18, 19, 1, 1, NULL, NULL);
INSERT INTO `<<prefix>>settings` (`id`, `key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`) VALUES(10, 'social_auth', 'Social Login', NULL, 'Social Network Login', NULL, 0, 20, 21, 1, 1, NULL, NULL);
INSERT INTO `<<prefix>>settings` (`id`, `key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`) VALUES(11, 'social_link', 'Social Network', NULL, 'Social Network Profiles', NULL, 0, 22, 23, 1, 1, NULL, NULL);
INSERT INTO `<<prefix>>settings` (`id`, `key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`) VALUES(12, 'optimization', 'Optimization', NULL, 'Optimization Tools', NULL, 0, 24, 25, 1, 1, NULL, NULL);
INSERT INTO `<<prefix>>settings` (`id`, `key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`) VALUES(13, 'seo', 'SEO', NULL, 'SEO Tools', NULL, 0, 26, 27, 1, 1, NULL, NULL);
INSERT INTO `<<prefix>>settings` (`id`, `key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`) VALUES(14, 'other', 'Others', NULL, 'Other Options', NULL, 0, 28, 29, 1, 1, NULL, NULL);
INSERT INTO `<<prefix>>settings` (`id`, `key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`) VALUES(15, 'cron', 'Cron', NULL, 'Cron Job', NULL, 0, 30, 31, 1, 1, NULL, NULL);
INSERT INTO `<<prefix>>settings` (`id`, `key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`) VALUES(16, 'footer', 'Footer', NULL, 'Pages Footer', NULL, 0, 32, 33, 1, 1, NULL, NULL);
INSERT INTO `<<prefix>>settings` (`id`, `key`, `name`, `value`, `description`, `field`, `parent_id`, `lft`, `rgt`, `depth`, `active`, `created_at`, `updated_at`) VALUES(17, 'backup', 'Backup', NULL, 'Backup Configuration', NULL, 0, 34, 35, 1, 1, NULL, NULL);
